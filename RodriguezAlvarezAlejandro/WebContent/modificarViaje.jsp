...
<title>ShareMyTrip - Editar viaje</title>
<body>
	<section>
		...
		<form action="modificarViaje?id=${trip.id}" method="post">
		<h2>Salida:</h2>
		<table>
			<tr>
				<td>Dirección*</td>
				<td><input type="text" name="direccionSalida"
					id="direccionSalida" size="30" value = "${trip.departure.address} "></td>
			...
			<tr>
				...
				<td><input type="text" name="ciudadSalida" id="ciudadSalida"
					size="30" value = "${trip.departure.city}" ></td>
			</tr>
			<tr>
				<td>Provincia*</td>
				<td><input type="text" name="provinciaSalida"
					id="provinciaSalida" size="30" value = "${trip.departure.state}"></td>
			</tr>
			<tr>
				<td>País*</td>
				<td><input type="text" name="paisSalida" id="paisSalida"
					size="30" value = "${trip.departure.country}"></td>
			</tr>
			<tr>
				<td>Código Postal*</td>
				<td><input type="text" name="cpSalida" id="cpSalida" size="30" value = "${trip.departure.zipCode}"></td>
			</tr>
			<tr>
				<td>Latitud GPS</td>
				<td><input type="text" name="latSalida" id="latSalida"
					size="30" value = "${trip.departure.waypoint.lat}"></td>
			</tr>
			<tr>
				<td>Longitud GPS</td>
				<td><input type="text" name="lonSalida" id="lonSalida"
					size="30" value = "${trip.departure.waypoint.lon}"></td>
			</tr>
			<tr>
				<td>Salida (DD/MM/YYYY HH:MM)*</td>
				<td><input type="text" name="fechaSalida" id="fechaSalida"
					size="30" value = "Inserte una fecha de salida..."></td>
			</tr>
		</table>
		<h2>Destino:</h2>
		<table>
			<tr>
				...
				<td><input type="text" name="direccionLlegada"
					id="direccionLlegada" size="30"value = "${trip.destination.address}"></td>
			</tr>
			<tr>
				<td>Ciudad*</td>
				<td><input type="text" name="ciudadLlegada" id="ciudadLlegada"
					size="30" value = "${trip.destination.city}"></td>
			</tr>
			<tr>
				<td>Provincia*</td>
				<td><input type="text" name="provinciaLlegada"
					id="provinciaLlegada" size="30" value = "${trip.destination.state}"></td>
			</tr>
			<tr>
				<td>País*</td>
				<td><input type="text" name="paisLlegada" id="paisLlegada"
					size="30" value = "${trip.destination.country}"></td>
			</tr>
			<tr>
				<td>Código Postal*</td>
				<td><input type="text" name="cpLlegada" id="cpLlegada"
					size="30" value = "${trip.destination.zipCode}"></td>
			</tr>
			<tr>
				<td>Latitud GPS</td>
				<td><input type="text" name="latLlegada" id="latLlegada"
					size="30" value = "${trip.destination.waypoint.lat}"></td>
			</tr>
			<tr>
				<td>Longitud GPS</td>
				<td><input type="text" name="lonLlegada" id="lonLlegada"
					size="30" value = "${trip.destination.waypoint.lon}"></td>
			</tr>
			<tr>
				<td>Llegada (DD/MM/YYYY HH:MM)*</td>
				<td><input type="text" name="fechaLlegada" id="fechaLlegada"
					size="30"   value = "Inserte una fecha de llegada..."></td>
			</tr>
		</table>
		<h2>Otros datos:</h2>
		<table>
			<tr>
				...
				<td><input type="text" name="fechaCierre" id="fechaCierre"
					size="30"  value = "Inserte una fecha de cierre..."></td>
			</tr>
			<tr>
				<td>Coste*</td>
				<td><input type="text" name="coste" id="coste" size="30"  value = "${trip.estimatedCost}"></td>
			</tr>
			<tr>
				<td>Comentarios</td>
				<td><input type="text" name="comentarios" id="comentarios"
					size="30"  value = "${trip.comments}"></td>
			</tr>
			<tr>
				<td>Plazas totales*</td>
				<td><input type="text" name="plazasTotales" id="plazasTotales"
					size="30"  value = "${trip.maxPax}"></td>
			</tr>
			<tr>
				<td>Plazas disponibles*</td>
				<td><input type="text" name="plazasDisponibles"
					id="plazasDisponibles" size="30"  value = "${trip.availablePax}"></td>
			</tr>
		</table>
		<br />
